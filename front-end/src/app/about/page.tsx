...
export default function About() {
  ...
  return (
    <>
    <section className="m-16 shadow-xl/20 flex justify-center bg-gradient-to-b from-[var(--foreground)] from-40% via-[var(--foreground-secondary)] via-70% to-[var(--foreground-tertiary)] to-100% rounded-xl ">
