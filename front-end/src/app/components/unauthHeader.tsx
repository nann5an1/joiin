          ...
          <div className="max-w-screen-xl flex flex-wrap items-center mr-18 mx-auto p-4">
            ...
            <div className="flex items-center justify-center w-full md:flex md:w-auto md:order-1" id="navbar-user">  
              {/* <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700"> */}
                <Link href="/upcoming_events" className="mr-8 font-medium block py-2 px-3 text-gray-900 rounded hover:bg-gray-900 md:hover:bg-transparent md:hover:text-blue-400 md:p-0 dark:text-white md:dark:hover:text-blue-500">Upcoming Events</Link>
